...
import { getProfileController, patchProfileController, postProfileController } from "../controllers/profile";
...
router.patch('/profile', authentication, supaUploads('image'), patchProfileController)
